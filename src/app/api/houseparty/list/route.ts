...
// Build an array of the last N nightKeys (<=10 allowed for Firestore "in")
...
export async function GET(req: Request) {
  try {
    ...
    // recent = last 7 nights (ok for "in" where clause, limit <= 10)
    ...
    const items = snap.docs
      ...
      .sort((a: any, b: any) => {
        ...
        const tb = b?.startsAt ? Date.parse(b.endsAt ?? b.startsAt) : 0;
        return tb - ta;
      });
